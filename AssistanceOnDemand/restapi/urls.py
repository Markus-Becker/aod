...
endpoints = patterns(
    ...
    #   FAQ
    #==================================
    url(r'^support/topics/(?P<topic>\d+)/articles$',rviews.ArticlesList.as_view(),                      name="articles_in_topic"),
    url(r'^support/search/articles$',               rviews.SearchArticlesList.as_view(),                name="search_articles"),
